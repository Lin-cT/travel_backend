...
class User(db.Model):
    ...
    def __init__(self, name, uid, password="123qwerty", role="User", itinerary='Mondsay: Swim'):
    ...
    # returns self
    def update(self, name="", uid="", password="", role="User", itinerary=""):
...
def initUsers():
    with app.app_context():
        ...
        u6 = User(name='Ben Chin', uid='BenC', password='123ben', role="Admin")
